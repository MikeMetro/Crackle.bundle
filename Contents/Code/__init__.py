...
URL_BROWSE_MOVIES = 'http://api.crackle.com/Service.svc/browse/movies/all/all/alpha/%s?format=json'
URL_BROWSE_TELEVISON = 'http://api.crackle.com/Service.svc/browse/television/all/all/alpha/%s?format=json'
URL_BROWSE_ORIGINALS = 'http://api.crackle.com/Service.svc/browse/originals/all/all/alpha/%s?format=json'
URL_BROWSE_COLLECTIONS = 'http://api.crackle.com/Service.svc/browse/collections/all/all/alpha/%s?format=json'
